...
public:
    ...
    void setupUi(QWidget *FormAddRule)
    {
        ...
        gridLayout->addWidget(comboBoxUs, 0, 2, 1, 1);
    ...
    void retranslateUi(QWidget *FormAddRule)
    {
        ...
        comboBoxUs->setItemText(0, QCoreApplication::translate("FormAddRule", "All", nullptr));
        comboBoxUs->setItemText(1, QCoreApplication::translate("FormAddRule", "STUDY", nullptr));
        comboBoxUs->setItemText(2, QCoreApplication::translate("FormAddRule", "ENTERTAINMENT", nullptr));
        comboBoxUs->setItemText(3, QCoreApplication::translate("FormAddRule", "LIFE", nullptr));
